  ...
  return (
    <section id="contact" className="section-padding">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          ref={ref}
          className="max-w-5xl mx-auto flex flex-col md:flex-row gap-10"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 md:p-8 h-full">
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-400 mr-3 mt-1">
                    <svg
              ...
              <div className="mt-8">
                ...
                <div className="flex space-x-4">
                  <motion.a
                    ...
                    className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-400"
