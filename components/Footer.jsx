  ...
  return (
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            <h2 className="text-2xl font-bold gradient-text mb-2">
              Adesh<span className="text-blue-500">.dev</span>
            </h2>
            <p className="text-gray-400 max-w-md">
              Flutter & Full Stack Developer with expertise in mobile and web development.
            </p>
          </motion.div>
        ...
        <motion.div
          className="mt-10 pt-6 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.4 }}
        >
          <p className="text-gray-500 text-sm">&copy; {currentYear} Adesh Rathod. All rights reserved.</p>
