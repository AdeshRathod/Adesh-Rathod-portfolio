          ...
          <motion.div className="md:w-1/2" variants={itemVariants}>
            <div className="relative">
              ...
              <div className="relative bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 md:p-8">
                <h3 className="text-2xl font-bold mb-4 gradient-text">Flutter & Full Stack Developer</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  I'm a passionate developer with over 1 year of experience in building cross-platform applications,
                  APIs, and microservices. I specialize in creating efficient, scalable, and user-friendly solutions
                  that solve real-world problems.
                </p>
                <p className="text-gray-700 dark:text-gray-300 mb-4">
                  My journey in tech began with a strong foundation in Information Technology at JSPM's RSCOE, Pune,
                  where I honed my skills in various programming languages and frameworks.
                </p>
                <p className="text-gray-700 dark:text-gray-300">
                  I've successfully delivered face-recognition-based attendance systems with over 90% accuracy and built
                  scalable real-time systems using Flutter, Kotlin, Node.js, and React.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div className="md:w-1/2" variants={itemVariants}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="card hover:border-blue-500 hover:border-2">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  I pride myself on delivering high-quality, reliable solutions that meet client requirements and
              ...
              <div className="card hover:border-blue-500 hover:border-2">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  I focus on creating optimized, efficient code that performs well even under high load conditions.
                </p>
              </div>
              ...
              <div className="card hover:border-blue-500 hover:border-2">
                ...
                <p className="text-gray-700 dark:text-gray-300">
                  I believe in clear communication and collaboration to ensure project success and client satisfaction.
                </p>
              </div>
            </div>
          </motion.div>
